...
from estructuras.lineales.nolineales.graph import Graph

class LoadGraph(QWidget):
    def __init__(self):
        super().__init__()
    ...
    def update_edge_list(self):
        ...
        for row_index, edge in enumerate(edges):
            ...
            item_vertex1.setTextAlignment(int(Qt.AlignmentFlag.AlignCenter))
            item_vertex2.setTextAlignment(int(Qt.AlignmentFlag.AlignCenter))
    ...
    def draw_graph(self):
        """Dibuja el grafo dentro del QGraphicsView."""
